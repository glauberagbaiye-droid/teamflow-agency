...
const CreateEventModal: React.FC<CreateEventModalProps> = ({ isOpen, onClose, onSave, artists }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-slate-900 w-full max-w-4xl max-h-[95vh] overflow-hidden rounded-3xl border border-amber-900/40 shadow-2xl flex flex-col lg:flex-row animate-scaleIn">
        ...
        {step === 'FORM' ? (
          <>
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="p-6 bg-slate-900 border-t border-amber-900/20 flex space-x-3">
                <button onClick={handleClose} className="flex-1 py-3 bg-slate-800 text-xs font-bold rounded-xl">Annulla</button>
                <button onClick={handleSubmit} className="flex-1 py-3 bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold rounded-xl flex items-center justify-center space-x-2">
                  <Save size={16} /> <span>Salva nell'App</span>
                </button>
              </div>
            </div>
          ...
          /* SUCCESS STEP */
          <div className="flex-1 p-10 flex flex-col items-center justify-center text-center space-y-8 animate-fadeIn">
            ...
            <button 
              onClick={handleClose}
              className="px-8 py-3 bg-indigo-600/20 text-indigo-400 border border-indigo-500/30 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-indigo-600 hover:text-white transition-all"
            >
